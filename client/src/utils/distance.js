...
export default function(destLatt, destLong) {
	const srcLatt = parseFloat(localStorage.getItem("latt"));
	const srcLong = parseFloat(localStorage.getItem("long"));

	return distance(srcLatt, srcLong, destLatt, destLong);
}
